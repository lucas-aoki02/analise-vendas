...
-- Coluna: mês, leads (#), vendas (#), receita (k, R$), conversão (%), ticket médio (k, R$)
...
-- VENDAS, RECEITA, CONVERSÃO{percentual de quantas visitas ao site resultaram em venda}, TICKET MÉDIO por mês
	payments as (
	select
...
-- (Query 3) Marcas que mais vendaram no mês
